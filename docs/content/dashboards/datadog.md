...
The native Datadog dashboard set is [DEP-115](https://linear.app/materializeinc/issue/DEP-115), scheduled for OO-M3 on the [roadmap](../../reference/internal/roadmap/).
...
See [otel-metrics-fanout](../../metrics/storing/) for the pipeline and `otel-metrics-fanout.values.yaml` for a working example.
