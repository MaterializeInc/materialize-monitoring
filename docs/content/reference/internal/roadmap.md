...
| Secret filtering for stored and egressed logs, the credentials half of [DEP-220](https://linear.app/materializeinc/issue/DEP-220) — design doc plus review | OO-M3 | 🔨 ([design doc](../design-docs/20260924-log-secret-filtering/) drafted; review outstanding) |
