...
[Style Guidelines]({{< relref "style-guidelines.md" >}}) for that voice.

## In this section

- **[SDKs and Schemas]({{< relref "sdks.md" >}})** — Grafana versions we target, Dashboard v1 vs v2 schema state, the
  vendored schemas, and the generated Rust models.
- **[Style Guidelines]({{< relref "style-guidelines.md" >}})** — palettes, layouts, panel visualization conventions,
  description voice, PromQL conventions, Materialize metric label families, known gotchas, and PromQL recipes.
- **[Generating and Pushing Dashboards]({{< relref "generating.md" >}})** — code structure, UID determinism, the
