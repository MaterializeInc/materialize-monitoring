...
This page covers the model and conventions for authoring alloy pipelines as YAML under `packages/alloy-pipelines/`. The runtime aspects (label families, retention) live in [Logging](/materialize-monitoring/preview/heather-roadmap-q4/reference/internal/pipelines/logging/) and [Metrics](/materialize-monitoring/preview/heather-roadmap-q4/reference/internal/pipelines/metrics/).
