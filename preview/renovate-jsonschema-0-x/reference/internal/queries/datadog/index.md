...
the [roadmap](/materialize-monitoring/preview/renovate-jsonschema-0-x/reference/internal/roadmap/).
...
See [Storing Metrics](/materialize-monitoring/preview/renovate-jsonschema-0-x/metrics/storing/) for the pipeline and `otel-metrics-fanout.values.yaml` for a working example.
