  ...
  <tbody>
    <tr>
      <td>Materialize Logs and Events
        <br />(<a href="/materialize-monitoring/preview/renovate-jsonschema-0-x/dashboards/grafana/env-logs.json?xxhash=943c1b701937d70b" download="mz-mon-env-logs-943c1b701937d70b.json"><code>env-logs.json</code></a>)
      </td>
...
<p>What the workloads said, as opposed to what they measured.</p>
    ...
    <tr>
      <td>Materialize Environment Overview
        <br />(<a href="/materialize-monitoring/preview/renovate-jsonschema-0-x/dashboards/grafana/env-top.json?xxhash=6be77f70e14054d1" download="mz-mon-env-top-6be77f70e14054d1.json"><code>env-top.json</code></a>)
      </td>
...
that may require further investigation.</p>
    ...
    <tr>
      <td>Materialize Upgrade
        <br />(<a href="/materialize-monitoring/preview/renovate-jsonschema-0-x/dashboards/grafana/env-upgrade.json?xxhash=11e79750fdfde4cc" download="mz-mon-env-upgrade-11e79750fdfde4cc.json"><code>env-upgrade.json</code></a>)
      </td>
...
what the cluster did underneath it.</p>
    ...
    <tr>
      <td>Infrastructure Logs and Events
        <br />(<a href="/materialize-monitoring/preview/renovate-jsonschema-0-x/dashboards/grafana/infra-logs.json?xxhash=d283fbfb8a6e250f" download="mz-mon-infra-logs-d283fbfb8a6e250f.json"><code>infra-logs.json</code></a>)
      </td>
...
<p>The monitoring stack, the Kubernetes system components, and the node journal.</p>
    ...
    <tr>
      <td>Infrastructure Node Detail
        <br />(<a href="/materialize-monitoring/preview/renovate-jsonschema-0-x/dashboards/grafana/infra-nodes.json?xxhash=3fb217a8dd0baf5b" download="mz-mon-infra-nodes-3fb217a8dd0baf5b.json"><code>infra-nodes.json</code></a>)
      </td>
