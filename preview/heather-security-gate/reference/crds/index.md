...
For the install procedure in context, see [Dependencies](/materialize-monitoring/preview/heather-security-gate/getting-started/dependencies/) and [Installing via Helm](/materialize-monitoring/preview/heather-security-gate/getting-started/helm/).
...
>  Removing them is a separate, explicit step — see [Uninstalling](/materialize-monitoring/preview/heather-security-gate/operating/uninstalling/).
...
See [Scraping](/materialize-monitoring/preview/heather-security-gate/metrics/scraping/#classic) for the downloads.
...
Progress is tracked in the [Rules & alerts](/materialize-monitoring/preview/heather-security-gate/reference/internal/roadmap/#rules--alerts) workstream.
...
| `GrafanaFolder` | **Created.** The folders the bundled dashboards are filed under — see [Folders](/materialize-monitoring/preview/heather-security-gate/dashboards/grafana/grafana-operator/#folders) |
...
See [Grafana Operator](/materialize-monitoring/preview/heather-security-gate/dashboards/grafana/grafana-operator/) and [Grafana Architecture](/materialize-monitoring/preview/heather-security-gate/dashboards/grafana/architecture/).
...
[o11y Troubleshooting](/materialize-monitoring/preview/heather-security-gate/operating/o11y-troubleshooting/) covers that path.
