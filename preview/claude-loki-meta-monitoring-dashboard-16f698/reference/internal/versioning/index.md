...
Renaming is supported, and takes a paired edit to the latest released heading in `CHANGELOG.md` to re-establish the baseline — see [Renaming a component](/materialize-monitoring/preview/claude-loki-meta-monitoring-dashboard-16f698/reference/internal/releasing/#renaming-a-component).
