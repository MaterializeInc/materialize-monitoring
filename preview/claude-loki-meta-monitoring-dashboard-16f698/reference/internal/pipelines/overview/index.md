...
- **[Authoring](/materialize-monitoring/preview/claude-loki-meta-monitoring-dashboard-16f698/reference/internal/pipelines/authoring/)** — schema model, strict-attributes policy, when to use `raw:` vs. extend the schema, how to add a new typed component or stage.
- **[Logging](/materialize-monitoring/preview/claude-loki-meta-monitoring-dashboard-16f698/reference/internal/pipelines/logging/)** — log pipeline conventions, label families, retention.
- **[Metrics](/materialize-monitoring/preview/claude-loki-meta-monitoring-dashboard-16f698/reference/internal/pipelines/metrics/)** — metrics pipeline conventions.
