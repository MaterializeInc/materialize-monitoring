...
For the dashboards themselves — what each one is for, and where to download it — see [Available Dashboards](/materialize-monitoring/preview/claude-materialize-deps-monitoring-design-9ff26d/dashboards/all/).

## Importing Dashboards via the Grafana UI

Download the corresponding `.json` file from [Available Dashboards](/materialize-monitoring/preview/claude-materialize-deps-monitoring-design-9ff26d/dashboards/all/).
...
1. Download the corresponding `.json` file from [Available Dashboards](/materialize-monitoring/preview/claude-materialize-deps-monitoring-design-9ff26d/dashboards/all/).
