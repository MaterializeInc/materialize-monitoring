...
For the install procedure in context, see [Dependencies](/materialize-monitoring/preview/renovate-hugo/getting-started/dependencies/) and [Installing via Helm](/materialize-monitoring/preview/renovate-hugo/getting-started/helm/).
...
>  Removing them is a separate, explicit step — see [Uninstalling](/materialize-monitoring/preview/renovate-hugo/operating/uninstalling/).
...
See [Scraping](/materialize-monitoring/preview/renovate-hugo/metrics/scraping/#classic) for the downloads.
...
Progress is tracked in the [Rules & alerts](/materialize-monitoring/preview/renovate-hugo/reference/internal/roadmap/#rules--alerts) workstream.
...
| `GrafanaFolder` | **Created.** The folders the bundled dashboards are filed under — see [Folders](/materialize-monitoring/preview/renovate-hugo/dashboards/grafana/grafana-operator/#folders) |
...
See [Grafana Operator](/materialize-monitoring/preview/renovate-hugo/dashboards/grafana/grafana-operator/) and [Grafana Architecture](/materialize-monitoring/preview/renovate-hugo/dashboards/grafana/architecture/).
...
**Google Managed Prometheus.** The repo ships `PodMonitoring` and `ClusterPodMonitoring` artifacts for the GMP path, but no template installs them — they are downloads for a GMP consumer, the same way the classic `ScrapeConfig` is. See [Scraping](/materialize-monitoring/preview/renovate-hugo/metrics/scraping/#gmp).
...
[o11y Troubleshooting](/materialize-monitoring/preview/renovate-hugo/operating/o11y-troubleshooting/) covers that path.
