...
For the install procedure in context, see [Dependencies](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/getting-started/dependencies/) and [Installing via Helm](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/getting-started/helm/).
...
>  Removing them is a separate, explicit step — see [Uninstalling](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/operating/uninstalling/).
...
See [Scraping](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/metrics/scraping/#classic) for the downloads.
...
Progress is tracked in the [Rules & alerts](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/reference/internal/roadmap/#rules--alerts) workstream.
...
| `GrafanaFolder` | **Created.** The folders the bundled dashboards are filed under — see [Folders](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/dashboards/grafana/grafana-operator/#folders) |
...
See [Grafana Operator](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/dashboards/grafana/grafana-operator/) and [Grafana Architecture](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/dashboards/grafana/architecture/).
...
[o11y Troubleshooting](/materialize-monitoring/preview/claude-thanos-loki-console-metrics-bmrfk6/operating/o11y-troubleshooting/) covers that path.
