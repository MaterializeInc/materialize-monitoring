...
[Render context](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/reference/internal/dashboard/sdks/#render-context).
...
> panel through the bridge — see [SDKs and Schemas](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/reference/internal/dashboard/sdks/#panels-do-not-write-promql).
