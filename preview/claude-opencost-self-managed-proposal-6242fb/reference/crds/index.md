...
For the install procedure in context, see [Dependencies](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/getting-started/dependencies/) and [Installing via Helm](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/getting-started/helm/).
...
>  Removing them is a separate, explicit step — see [Uninstalling](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/operating/uninstalling/).
...
See [Scraping](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/metrics/scraping/#classic) for the downloads.
...
Progress is tracked in the [Rules & alerts](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/reference/internal/roadmap/#rules--alerts) workstream.
...
| `GrafanaFolder` | **Created.** The folders the bundled dashboards are filed under — see [Folders](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/dashboards/grafana/grafana-operator/#folders) |
...
See [Grafana Operator](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/dashboards/grafana/grafana-operator/) and [Grafana Architecture](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/dashboards/grafana/architecture/).
...
[o11y Troubleshooting](/materialize-monitoring/preview/claude-opencost-self-managed-proposal-6242fb/operating/o11y-troubleshooting/) covers that path.
