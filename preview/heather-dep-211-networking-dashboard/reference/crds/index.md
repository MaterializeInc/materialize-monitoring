...
For the install procedure in context, see [Dependencies](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/getting-started/dependencies/) and [Installing via Helm](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/getting-started/helm/).
...
>  Removing them is a separate, explicit step — see [Uninstalling](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/operating/uninstalling/).
...
See [Scraping](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/metrics/scraping/#classic) for the downloads.
...
Progress is tracked in the [Rules & alerts](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/reference/internal/roadmap/#rules--alerts) workstream.
...
| `GrafanaFolder` | **Created.** The folders the bundled dashboards are filed under — see [Folders](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/dashboards/grafana/grafana-operator/#folders) |
...
See [Grafana Operator](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/dashboards/grafana/grafana-operator/) and [Grafana Architecture](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/dashboards/grafana/architecture/).
...
[o11y Troubleshooting](/materialize-monitoring/preview/heather-dep-211-networking-dashboard/operating/o11y-troubleshooting/) covers that path.
