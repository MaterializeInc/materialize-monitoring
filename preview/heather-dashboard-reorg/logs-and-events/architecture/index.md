...
This page describes how container logs and Kubernetes [events](../../o11y-glossary/#logs-and-events) move through `materialize-monitoring`: collected at the edge by [Alloy](../../o11y-glossary/#collection-and-pipeline), stored in [Loki](../../o11y-glossary/#stack-components) (the default logging backend), and queried through Grafana.

The other pages in this section cover each stage in depth, including its day-2 and customization operations:
