...
[Render context](/materialize-monitoring/preview/claude-mz-alloy-version-bump-iftvmn/reference/internal/dashboard/sdks/#render-context).
...
> panel through the bridge — see [SDKs and Schemas](/materialize-monitoring/preview/claude-mz-alloy-version-bump-iftvmn/reference/internal/dashboard/sdks/#panels-do-not-write-promql).
