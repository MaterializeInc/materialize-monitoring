...
Renaming is supported, and takes a paired edit to the latest released heading in `CHANGELOG.md` to re-establish the baseline — see [Renaming a component](/materialize-monitoring/preview/claude-alloy-logs-cluster-field-eec578/reference/internal/releasing/#renaming-a-component).
