...
- **[Authoring](/materialize-monitoring/preview/claude-headlamp-cluster-management-82b31a/reference/internal/pipelines/authoring/)** — schema model, strict-attributes policy, when to use `raw:` vs. extend the schema, how to add a new typed component or stage.
- **[Logging](/materialize-monitoring/preview/claude-headlamp-cluster-management-82b31a/reference/internal/pipelines/logging/)** — log pipeline conventions, label families, retention.
- **[Metrics](/materialize-monitoring/preview/claude-headlamp-cluster-management-82b31a/reference/internal/pipelines/metrics/)** — metrics pipeline conventions.
