...
They render side by side as tabs on [Common Queries](/materialize-monitoring/preview/claude-headlamp-cluster-management-82b31a/reference/stable-metrics/common-queries/); this
...
the [roadmap](/materialize-monitoring/preview/claude-headlamp-cluster-management-82b31a/reference/internal/roadmap/).
...
See [Storing Metrics](/materialize-monitoring/preview/claude-headlamp-cluster-management-82b31a/metrics/storing/) for the pipeline and `otel-metrics-fanout.values.yaml` for a working example.
