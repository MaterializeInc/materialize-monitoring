...
[Render context](/materialize-monitoring/preview/claude-alert-manager-self-managed-proposal-596b57/reference/internal/dashboard/sdks/#render-context).
...
> panel through the bridge — see [SDKs and Schemas](/materialize-monitoring/preview/claude-alert-manager-self-managed-proposal-596b57/reference/internal/dashboard/sdks/#panels-do-not-write-promql).
