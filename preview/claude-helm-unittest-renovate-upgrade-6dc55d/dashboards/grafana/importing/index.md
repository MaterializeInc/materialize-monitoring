...
For the dashboards themselves — what each one is for, and where to download it — see [Available Dashboards](/materialize-monitoring/preview/claude-helm-unittest-renovate-upgrade-6dc55d/dashboards/all/).

## Importing Dashboards via the Grafana UI

Download the corresponding `.json` file from [Available Dashboards](/materialize-monitoring/preview/claude-helm-unittest-renovate-upgrade-6dc55d/dashboards/all/).
...
1. Download the corresponding `.json` file from [Available Dashboards](/materialize-monitoring/preview/claude-helm-unittest-renovate-upgrade-6dc55d/dashboards/all/).
