...
For the install procedure in context, see [Dependencies](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/getting-started/dependencies/) and [Installing via Helm](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/getting-started/helm/).
...
>  Removing them is a separate, explicit step — see [Uninstalling](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/operating/uninstalling/).
...
See [Scraping](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/metrics/scraping/#classic) for the downloads.
...
Progress is tracked in the [Rules & alerts](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/reference/internal/roadmap/#rules--alerts) workstream.
...
| `GrafanaFolder` | **Created.** The folders the bundled dashboards are filed under — see [Folders](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/dashboards/grafana/grafana-operator/#folders) |
...
See [Grafana Operator](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/dashboards/grafana/grafana-operator/) and [Grafana Architecture](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/dashboards/grafana/architecture/).
...
[o11y Troubleshooting](/materialize-monitoring/preview/renovate-gcr-io-distroless-base-debian13/operating/o11y-troubleshooting/) covers that path.
