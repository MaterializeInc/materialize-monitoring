...
If you are installing the `materialize-monitoring` chart, you do not need to download anything — `dashboards.selected` defaults to `["env-*", "infra-*"]`, which is all of them, and the [Grafana Operator](/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/grafana-operator/) path keeps them in sync rather than importing a point-in-time copy.
Download them when you are putting them into a Grafana you run yourself; [Importing Dashboards](/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/importing/) covers the ways to do that.

## Formats

Only the **Grafana dashboard schema v2** render exists so far, and it needs **Grafana 12 or later** — see [Grafana compatibility](/materialize-monitoring/preview/heather-panic-captures/reference/compatibility/#grafana).
Each table below still lists the other formats, so it is clear which ones a dashboard has no render for yet.
The Grafana 10 and 11 (schema v1) renders and the Datadog, Google Cloud Monitoring, and Honeycomb sets are tracked on the [roadmap](/materialize-monitoring/preview/heather-panic-captures/reference/internal/roadmap/#dashboards); until they land, [Common Queries](/materialize-monitoring/preview/heather-panic-captures/reference/stable-metrics/common-queries/) is the query material to build one yourself.
...
<table class="download-dashboards">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/env-top.json?xxhash=067e270f5f05f836" download="mz-mon-env-top.json"><code>env-top.json</code></a>
...
<table class="download-dashboards">
  ...
  <tbody>
    <tr>
      <td>Grafana 12 and 13<br /><small>dashboard schema v2</small></td>
      <td>
        <a href="/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/env-logs.json?xxhash=a8ae7dead9209cc2" download="mz-mon-env-logs.json"><code>env-logs.json</code></a>
...
> On an older release it degrades unevenly rather than going dark, and [compatibility](/materialize-monitoring/preview/heather-panic-captures/reference/compatibility/#materialize-product) has the per-tab detail.
...
<table class="download-dashboards">
  ...
  <tbody>
    <tr>
      <td>Grafana 12 and 13<br /><small>dashboard schema v2</small></td>
      <td>
        <a href="/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/env-upgrade.json?xxhash=67ea29c2cabdc309" download="mz-mon-env-upgrade.json"><code>env-upgrade.json</code></a>
...
<table class="download-dashboards">
  ...
  <tbody>
    <tr>
      <td>Grafana 12 and 13<br /><small>dashboard schema v2</small></td>
      <td>
        <a href="/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/infra-nodes.json?xxhash=61eb53a1aae6d0de" download="mz-mon-infra-nodes.json"><code>infra-nodes.json</code></a>
...
<table class="download-dashboards">
  ...
  <tbody>
    <tr>
      <td>Grafana 12 and 13<br /><small>dashboard schema v2</small></td>
      <td>
        <a href="/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/infra-logs.json?xxhash=eb22e84fcee7f65d" download="mz-mon-infra-logs.json"><code>infra-logs.json</code></a>
...
<table class="download-dashboards">
  ...
  <tbody>
    <tr>
      <td>Grafana 12 and 13<br /><small>dashboard schema v2</small></td>
      <td>
        <a href="/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/infra-net.json?xxhash=7cf14d5efa051e8c" download="mz-mon-infra-net.json"><code>infra-net.json</code></a>
...
The manifests the [Grafana Operator](/materialize-monitoring/preview/heather-panic-captures/dashboards/grafana/grafana-operator/) applies carry the same annotations.
