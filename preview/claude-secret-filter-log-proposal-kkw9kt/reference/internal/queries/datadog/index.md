...
They render side by side as tabs on [Common Queries](/materialize-monitoring/preview/claude-secret-filter-log-proposal-kkw9kt/reference/stable-metrics/common-queries/); this
...
the [roadmap](/materialize-monitoring/preview/claude-secret-filter-log-proposal-kkw9kt/reference/internal/roadmap/).
...
See [Storing Metrics](/materialize-monitoring/preview/claude-secret-filter-log-proposal-kkw9kt/metrics/storing/) for the pipeline and `otel-metrics-fanout.values.yaml` for a working example.
