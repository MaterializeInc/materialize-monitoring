...
Renaming is supported, and takes a paired edit to the latest released heading in `CHANGELOG.md` to re-establish the baseline — see [Renaming a component](/materialize-monitoring/preview/claude-secret-filter-log-proposal-kkw9kt/reference/internal/releasing/#renaming-a-component).
