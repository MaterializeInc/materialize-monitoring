...
They render side by side as tabs on [Common Queries](/materialize-monitoring/preview/claude-rnd-design-docs-workflow-bb1e2b/reference/stable-metrics/common-queries/); this
...
the [roadmap](/materialize-monitoring/preview/claude-rnd-design-docs-workflow-bb1e2b/reference/internal/roadmap/).
...
See [Storing Metrics](/materialize-monitoring/preview/claude-rnd-design-docs-workflow-bb1e2b/metrics/storing/) for the pipeline and `otel-metrics-fanout.values.yaml` for a working example.
